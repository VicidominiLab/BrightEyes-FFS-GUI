...
def get_params(det_type='Square 5x5'):
    if det_type=='Square 5x5':
        ...
        for angle in [0, 60, 120, 180, 240, 300]:
            for dist in [1, 2]:
                elements.append('Angle' + str(angle) + '_' + str(dist))
        average = ['12x3+3x0+0x6+6x18+11x2+2x1+1x7+10x9+9x8+13x4+4x5+5x17+14x15+15x16',
                   '0x18+3x6+12x0+2x7+11x1+10x8+4x17+13x5+14x16',
                   '10x2+2x0+0x5+5x16+9x1+1x6+6x17+8x7+7x18+11x3+3x4+4x15+12x13+13x14',
                   '0x16+2x5+10x0+1x17+9x6+8x18+3x15+11x4+12x14',
                   '8x1+1x0+0x4+4x14+7x6+6x5+5x15+18x17+17x16+9x2+2x3+3x13+10x11+11x12',
                   '0x14+1x4+8x0+2x13+9x3+10x12+6x15+7x5+18x16',
                   '18x6+6x0+0x3+3x12+7x1+1x2+2x11+8x9+9x10+17x5+5x4+4x13+16x15+15x14',
                   '0x12+6x3+18x0+17x4+5x13+16x14+7x2+1x11+8x10',
                   '16x5+5x0+0x2+2x10+17x6+6x1+1x9+18x7+7x8+15x4+4x3+3x11+14x13+13x12',
