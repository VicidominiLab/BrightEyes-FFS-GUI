...
def get_params():
    return {
        ...
        "paramNames"           : ["N", "D (um^2/s)", "w2 (nm)", "Shape parameter", "rho x (nm)", "rho y (nm)", "vx (mm/s)", "vy (mm/s)", "Offset"],
        "paramFittable"        : [True, True, True, False, False, False, True, True, True],
        "globalParam"          : [True, True, False, False, False, False, True, True, False],
        ...
        "paramMinbound"        : [0, 1e-3, 5e-2, 0, -1e6, -1e6, -1e9, -1e9, -1e2],
        "paramMaxbound"        : [1e6, 1000, 1e4, 1e6, 1e6, 1e6, 1e9, 1e9, 1e6],
