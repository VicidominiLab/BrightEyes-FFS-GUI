from brighteyes_ffs.fcs.fcs_analytical import fcs_finitelength
...
def get_params():
    return {
        ...
        "paramFactors10"       : [1, 1e-3, 1, 1, 1e-3, 1],
        ...
        "fitfunctionName"      : fcs_finitelength,
        "fitfunctionParamUsed" : [0, 1, 2, 4, 5, 3]
    }
